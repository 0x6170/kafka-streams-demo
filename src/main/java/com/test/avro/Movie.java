...
public class Movie extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2339682929358717446L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Movie\",\"namespace\":\"com.test.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"title\",\"type\":\"string\"},{\"name\":\"release_year\",\"type\":\"int\"}]}");
   ...
   */
  public Movie(Long id, CharSequence title, Integer release_year) {
    this.id = id;
    this.title = title;
   ...
   * @return A new Movie RecordBuilder
   */
  public static Builder newBuilder(Movie other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
