...
public class Rating extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1356869046726038670L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Rating\",\"namespace\":\"com.test.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"rating\",\"type\":\"double\"}]}");
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: rating = (Double)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Rating>
    ...
    public Rating build() {
      try {
        ...
        record.rating = fieldSetFlags()[1] ? this.rating : (Double) defaultValue(fields()[1]);
        return record;
