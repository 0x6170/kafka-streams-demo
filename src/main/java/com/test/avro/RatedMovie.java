...
public class RatedMovie extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3853583429471922861L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RatedMovie\",\"namespace\":\"com.test.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"title\",\"type\":\"string\"},{\"name\":\"release_year\",\"type\":\"int\"},{\"name\":\"rating\",\"type\":\"double\"}]}");
   ...
   */
  public RatedMovie(Long id, CharSequence title, Integer release_year, Double rating) {
    this.id = id;
    this.title = title;
  ...
  public void put(int field$, Object value$) {
    ...
    case 2: release_year = (Integer)value$; break;
    case 3: rating = (Double)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return A new RatedMovie RecordBuilder
   */
  public static Builder newBuilder(RatedMovie other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RatedMovie>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(RatedMovie other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    public RatedMovie build() {
      try {
        ...
        record.release_year = fieldSetFlags()[2] ? this.release_year : (Integer) defaultValue(fields()[2]);
        record.rating = fieldSetFlags()[3] ? this.rating : (Double) defaultValue(fields()[3]);
        return record;
